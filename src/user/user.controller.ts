...
export class UserController {
    ...
    @ApiConsumes('multipart/form-data')// giup bien tau dang chon file
    @ApiBody({
        type: FileUploadDto,
    ...
    @UseInterceptors(FileInterceptor("file", {
        storage: diskStorage({
            destination: process.cwd() + "/public/imgs",// luu file
            filename: (req, file, callback) => callback(null, Date.now() + "_" + file.originalname) // doi ten file 
        })
    }))
